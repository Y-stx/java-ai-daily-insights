<!-- generated_at: 2026-09-11T08:30:23+08:00 -->

# 2026-09-11 从 dromara/skyeye 看 Java AI 工程化：给大二升大三学生的学习文章

> 生成时间：2026-09-11 08:30 CST
> 读者定位：中北大学软件学院大二升大三学生，已具备 Java、数据库、Web 基础，正在补工程化与 AI 应用开发能力。
> 今日主题：从 `dromara/skyeye` 延伸理解 Java AI 应用、RAG、Agent、招聘能力要求和比赛实践。
...
![dromara/skyeye GitHub 项目卡片](https://opengraph.githubassets.com/java-ai-daily-insights/dromara/skyeye)

今天可以重点看 `dromara/skyeye`。

- **项目一句话理解**：智能办公OA系统[SpringBoot2-快速开发平台]，适用于医院，学校，中小型企业等机构的管理。Activiti5.22+动态表单实现零java代码即可做到复杂业务的流程实施，同时包含文件在线操作、日志、考勤、CRM、ERP进销存、项目、拖拽式生成问卷、日程、笔记、计划、行政等多种复杂业务功能。同时，可进行授权二开。
- **语言与热度**：Java；Star：1215；最近更新：2026-09-11T00:25:20Z。
- **原始链接**：https://github.com/dromara/skyeye
...
| Hugging Face Blog | [Rebuilding AUTOMATIC1111 with Gradio Workflow](https://huggingface.co/blog/gradio-workflow-1111)<br>[IBM releases SOTA Granite Time Series PatchTST-FM-r2 model with commercial-friendly license](https://huggingface.co/blog/ibm-research/ibm-releases-sota-granite-time-series) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
| Planet AI | [Any Nix package, live in your browser](https://simonwillison.net/2026/Sep/10/trynix/)<br>[OpenAI Wants to Know if an AI Industry Slowdown Would Even Be Legal](https://www.wired.com/story/openai-wants-to-know-if-an-ai-industry-slowdown-would-even-be-legal/) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
...
| 项目 | 描述 | 链接 |
| --- | --- | --- |
| `dromara/skyeye` | 智能办公OA系统[SpringBoot2-快速开发平台]，适用于医院，学校，中小型企业等机构的管理。Activiti5.22+动态表单实现零java代码即可做到复杂业务的流程实施，同时包含文件在线操作、日志、考勤、CRM、ERP进销存、项目、拖拽式生成问卷、日程、笔记、计划、行政等多种复杂业务功能。同时，可进行授权二开。 | https://github.com/dromara/skyeye |
...
- `dromara/skyeye`：https://github.com/dromara/skyeye
...
- 生成模式：本地模板 fallback。原因：模型 API 返回 HTTP 502，已切换为本地模板 fallback
