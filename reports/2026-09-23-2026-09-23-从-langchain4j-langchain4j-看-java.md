<!-- generated_at: 2026-09-23T08:30:16+08:00 -->

# 2026-09-23 从 langchain4j/langchain4j 看 Java AI 工程化：给大二升大三学生的学习文章
...
| Hugging Face Blog | [How UK AISI and EvalEval Are Making Benchmark Results Reproducible](https://huggingface.co/blog/evaleval-aisi)<br>[Transformers now runs llama.cpp quants](https://huggingface.co/blog/transformers-llama-cpp-quants) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
