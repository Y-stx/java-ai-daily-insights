<!-- generated_at: 2026-07-11T20:25:09+08:00 -->

# 2026-07-11 从 alibaba/spring-ai-alibaba 看 Java AI 工程化：给大二升大三学生的学习文章

> 生成时间：2026-07-11 20:25 CST
...
- 生成模式：本地模板 fallback。原因：当前环境未配置 MODEL_API_KEY 或 OPENAI_API_KEY，未发起模型 API 调用
