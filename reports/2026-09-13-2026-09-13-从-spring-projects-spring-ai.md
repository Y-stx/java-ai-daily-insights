<!-- generated_at: 2026-09-13T08:31:50+08:00 -->

# 2026-09-13 从 spring-projects/spring-ai 看 Java AI 工程化：给大二升大三学生的学习文章

> 生成时间：2026-09-13 08:31 CST
...
| Planet AI | [Perplexity trusts GPT-6 Astra with end-to-end systems](https://openai.com/index/perplexity-improving-accuracy-with-astra)<br>[b10934](https://github.com/ggml-org/llama.cpp/releases/tag/b10934) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
