<!-- generated_at: 2026-09-22T08:31:50+08:00 -->

# 2026-09-22 从 langchain4j/langchain4j 看 Java AI 工程化：给大二升大三学生的学习文章

> 生成时间：2026-09-22 08:31 CST
...
| Hugging Face Blog | [Pruning LLMs Like a Physicist: Block Removal as an Ising Optimization Problem](https://huggingface.co/blog/MultiverseComputingCAI/pruning-llms-like-a-physicist-block-removal-as-an)<br>[tokenizers v1: encode, decode and scaling, measured](https://huggingface.co/blog/tokenizers-v1) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
| Planet AI | [The man who built Apple’s stores doesn’t buy Silicon Valley’s bet on AI shopping](https://techcrunch.com/2026/09/21/the-man-who-built-apples-stores-doesnt-buy-silicon-valleys-bet-on-ai-shopping/)<br>[b11090](https://github.com/ggml-org/llama.cpp/releases/tag/b11090) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
...
| 项目 | 描述 | 链接 |
| --- | --- | --- |
| `Dicklesworthstone/ultimate_bug_scanner` | Static analysis tool that catches 1000+ bug patterns across all popular programming languages, with auto-wiring into AI coding agent quality guardrails | https://github.com/Dicklesworthstone/ultimate_bug_scanner |
...
- `Dicklesworthstone/ultimate_bug_scanner`：https://github.com/Dicklesworthstone/ultimate_bug_scanner
