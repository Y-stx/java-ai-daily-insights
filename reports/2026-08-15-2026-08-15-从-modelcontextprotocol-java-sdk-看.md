<!-- generated_at: 2026-08-15T08:31:50+08:00 -->

# 2026-08-15 从 modelcontextprotocol/java-sdk 看 Java AI 工程化：给大二升大三学生的学习文章

> 生成时间：2026-08-15 08:31 CST
...
| Hugging Face Blog | [State of Open Models: Summer 2026 Observations](https://huggingface.co/blog/state-of-open-models-summer-2026)<br>[Record, train, and deploy from one place with Strands Agents, LeRobot, and Hugging Face Storage Buckets](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
| Planet AI | [The Next Big Influencer Is This 4-Foot-Tall Robot From China](https://www.wired.com/story/unitree-influencer-4-foot-robot-from-china/)<br>[Drug that targets an inflammatory enzyme could help prevent lung cancer](https://news.mit.edu/2026/drug-targeting-inflammatory-enzyme-could-help-prevent-lung-cancer-0814) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
...
| `WeThinkIn/AIGC-Interview-Book` | 【三年面试五年模拟】AIGC/LLM/AI Agent算法工程师面试秘籍。涵盖AIGC、LLM大模型、AI Agent、具身智能、传统深度学习、自动驾驶、机器学习、计算机视觉、自然语言处理、强化学习、大数据挖掘、世界模型、元宇宙、AGI等AI行业面试笔试干货经验与核心跨周期知识。 | https://github.com/WeThinkIn/AIGC-Interview-Book |
| `andrew/ultimate-awesome` | Every awesome list on every topic, including awesome lists of awesome lists, updated daily. | https://github.com/andrew/ultimate-awesome |
| `mxsm/rocketmq-rust` | 🚀Apache RocketMQ build in  Rust🦀. Faster, safer, and with lower memory usage. ⭐ Star to support our work❤️! | https://github.com/mxsm/rocketmq-rust |
| `spiculedata/saiku` | Open-source semantic layer: one cube for Excel (MDX/XMLA), dashboards, and AI agents (MCP). Mondrian + Apache Calcite. | https://github.com/spiculedata/saiku |
