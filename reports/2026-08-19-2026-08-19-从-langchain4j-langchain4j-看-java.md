<!-- generated_at: 2026-08-19T08:31:50+08:00 -->

# 2026-08-19 从 langchain4j/langchain4j 看 Java AI 工程化：给大二升大三学生的学习文章

> 生成时间：2026-08-19 08:31 CST
...
| Hugging Face Blog | [How Much Memory Does Your Agent Actually Need?](https://huggingface.co/blog/ibm-research/altk-evolve-hmm)<br>[Multi-Vector (Late Interaction) Embedding Models with Sentence Transformers](https://huggingface.co/blog/multi-vector-encoder) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
| Planet AI | [Cursor capitalizes on GitHub frustration, launches rival hosting platform](https://techcrunch.com/2026/08/18/cursor-capitalizes-on-github-frustration-launches-rival-hosting-platform/)<br>[NVIDIA Releases TensorRT Model Connect in Public Preview: Hugging Face Checkpoint to Native C++ Inference in Two Commands](https://www.marktechpost.com/2026/08/18/nvidia-releases-tensorrt-model-connect-in-public-preview-hugging-face-checkpoint-to-native-c-inference-in-two-commands/) | 先看标题和摘要，判断它和模型调用、RAG、Agent、开发工具哪一类能力有关。 |
...
| 项目 | 描述 | 链接 |
| --- | --- | --- |
| `ministackorg/ministack` | Ministack: Free, open-source local AWS emulator - 60+ services, Terraform compatible, real databases. Free forever. MIT   licensed. | https://github.com/ministackorg/ministack |
| `QwenLM/qwen-code` | An open-source AI coding agent that lives in your terminal. | https://github.com/QwenLM/qwen-code |
...
| 整理一个业务知识库样例，完成文档切分、Embedding 字段设计和向量库元数据设计。 | 30-90 分钟 | 一段代码、一个接口截图或一页笔记 |
...
- `ministackorg/ministack`：https://github.com/ministackorg/ministack
